...
env.app_string = ""
env.DEV_DB_URL = "postgres://@localhost:5432/footprints"

env.SERVERS = {
    "live": "footprints",
    "staging": "footprints-staging",
}
...
def setup_db():
    local_venv("dropdb footprints --if-exists -U skoczen")
    local_venv("createdb footprints -U skoczen")
