...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'posts_post', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.description'
        db.add_column(u'posts_postrevision', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'posts_post', 'description')

        # Deleting field 'PostRevision.description'
        db.delete_column(u'posts_postrevision', 'description')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 24, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
