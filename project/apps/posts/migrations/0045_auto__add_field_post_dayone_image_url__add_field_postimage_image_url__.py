...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.dayone_image_url'
        db.add_column(u'posts_post', 'dayone_image_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostImage.image_url'
        db.add_column(u'posts_postimage', 'image_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.dayone_image_url'
        db.add_column(u'posts_postrevision', 'dayone_image_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.dayone_image_url'
        db.delete_column(u'posts_post', 'dayone_image_url')

        # Deleting field 'PostImage.image_url'
        db.delete_column(u'posts_postimage', 'image_url')

        # Deleting field 'PostRevision.dayone_image_url'
        db.delete_column(u'posts_postrevision', 'dayone_image_url')
