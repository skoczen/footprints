...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.dayone_post'
        db.add_column(u'posts_post', 'dayone_post',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Post.dayone_id'
        db.add_column(u'posts_post', 'dayone_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.dayone_last_modified'
        db.add_column(u'posts_post', 'dayone_last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.dayone_post'
        db.delete_column(u'posts_post', 'dayone_post')

        # Deleting field 'Post.dayone_id'
        db.delete_column(u'posts_post', 'dayone_id')

        # Deleting field 'Post.dayone_last_modified'
        db.delete_column(u'posts_post', 'dayone_last_modified')
