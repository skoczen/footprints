...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.dropbox_day_one_folder_path'
        db.add_column(u'posts_author', 'dropbox_day_one_folder_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.dropbox_day_one_folder_path'
        db.delete_column(u'posts_author', 'dropbox_day_one_folder_path')
    ...
    models = {
        ...
        u'posts.author': {
            ...
            'dropbox_day_one_folder_path': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
