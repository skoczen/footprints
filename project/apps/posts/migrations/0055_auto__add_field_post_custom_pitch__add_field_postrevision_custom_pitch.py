...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.custom_pitch'
        db.add_column(u'posts_post', 'custom_pitch',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.custom_pitch'
        db.add_column(u'posts_postrevision', 'custom_pitch',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.custom_pitch'
        db.delete_column(u'posts_post', 'custom_pitch')

        # Deleting field 'PostRevision.custom_pitch'
        db.delete_column(u'posts_postrevision', 'custom_pitch')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 11, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
