...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.twitter_mentions'
        db.add_column(u'posts_post', 'twitter_mentions',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_mentions'
        db.add_column(u'posts_postrevision', 'twitter_mentions',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.twitter_mentions'
        db.delete_column(u'posts_post', 'twitter_mentions')

        # Deleting field 'PostRevision.twitter_mentions'
        db.delete_column(u'posts_postrevision', 'twitter_mentions')
