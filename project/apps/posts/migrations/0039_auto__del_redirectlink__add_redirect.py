...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RedirectLink'
        db.delete_table(u'posts_redirectlink')

        # Adding model 'Redirect'
        db.create_table(u'posts_redirect', (
            ...
            ('old_url', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('new_url', self.gf('django.db.models.fields.CharField')(max_length=600)),
        ))
        db.send_create_signal(u'posts', ['Redirect'])


    def backwards(self, orm):
        # Adding model 'RedirectLink'
        db.create_table(u'posts_redirectlink', (
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.Author'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('new_url', self.gf('django.db.models.fields.CharField')(max_length=600)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'posts', ['RedirectLink'])

        # Deleting model 'Redirect'
        db.delete_table(u'posts_redirect')
    ...
    models = {
        ...
        u'posts.redirect': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_url': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'old_url': ('django.db.models.fields.CharField', [], {'max_length': '600'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        }
    }
