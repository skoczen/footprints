...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.email_publish_intent'
        db.add_column(u'posts_post', 'email_publish_intent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PostRevision.email_publish_intent'
        db.add_column(u'posts_postrevision', 'email_publish_intent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.email_publish_intent'
        db.delete_column(u'posts_post', 'email_publish_intent')

        # Deleting field 'PostRevision.email_publish_intent'
        db.delete_column(u'posts_postrevision', 'email_publish_intent')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'email_publish_intent': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 18, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
