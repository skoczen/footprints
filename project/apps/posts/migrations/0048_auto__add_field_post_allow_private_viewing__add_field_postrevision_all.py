...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.allow_private_viewing'
        db.add_column(u'posts_post', 'allow_private_viewing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PostRevision.allow_private_viewing'
        db.add_column(u'posts_postrevision', 'allow_private_viewing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.allow_private_viewing'
        db.delete_column(u'posts_post', 'allow_private_viewing')

        # Deleting field 'PostRevision.allow_private_viewing'
        db.delete_column(u'posts_postrevision', 'allow_private_viewing')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 25, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
