...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.twitter_published'
        db.add_column(u'posts_post', 'twitter_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Post.twitter_status_text'
        db.add_column(u'posts_post', 'twitter_status_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.twitter_status_id'
        db.add_column(u'posts_post', 'twitter_status_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_published'
        db.add_column(u'posts_postrevision', 'twitter_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_status_text'
        db.add_column(u'posts_postrevision', 'twitter_status_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_status_id'
        db.add_column(u'posts_postrevision', 'twitter_status_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.twitter_published'
        db.delete_column(u'posts_post', 'twitter_published')

        # Deleting field 'Post.twitter_status_text'
        db.delete_column(u'posts_post', 'twitter_status_text')

        # Deleting field 'Post.twitter_status_id'
        db.delete_column(u'posts_post', 'twitter_status_id')

        # Deleting field 'PostRevision.twitter_published'
        db.delete_column(u'posts_postrevision', 'twitter_published')

        # Deleting field 'PostRevision.twitter_status_text'
        db.delete_column(u'posts_postrevision', 'twitter_status_text')

        # Deleting field 'PostRevision.twitter_status_id'
        db.delete_column(u'posts_postrevision', 'twitter_status_id')
