...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.twitter_likes'
        db.delete_column(u'posts_post', 'twitter_likes')

        # Deleting field 'Post.twitter_shares'
        db.delete_column(u'posts_post', 'twitter_shares')

        # Adding field 'Post.facebook_likes'
        db.add_column(u'posts_post', 'facebook_likes',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.facebook_shares'
        db.add_column(u'posts_post', 'facebook_shares',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.facebook_comments'
        db.add_column(u'posts_post', 'facebook_comments',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PostRevision.twitter_likes'
        db.delete_column(u'posts_postrevision', 'twitter_likes')

        # Deleting field 'PostRevision.twitter_shares'
        db.delete_column(u'posts_postrevision', 'twitter_shares')

        # Adding field 'PostRevision.facebook_likes'
        db.add_column(u'posts_postrevision', 'facebook_likes',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.facebook_shares'
        db.add_column(u'posts_postrevision', 'facebook_shares',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.facebook_comments'
        db.add_column(u'posts_postrevision', 'facebook_comments',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.twitter_likes'
        db.add_column(u'posts_post', 'twitter_likes',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.twitter_shares'
        db.add_column(u'posts_post', 'twitter_shares',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Post.facebook_likes'
        db.delete_column(u'posts_post', 'facebook_likes')

        # Deleting field 'Post.facebook_shares'
        db.delete_column(u'posts_post', 'facebook_shares')

        # Deleting field 'Post.facebook_comments'
        db.delete_column(u'posts_post', 'facebook_comments')

        # Adding field 'PostRevision.twitter_likes'
        db.add_column(u'posts_postrevision', 'twitter_likes',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_shares'
        db.add_column(u'posts_postrevision', 'twitter_shares',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PostRevision.facebook_likes'
        db.delete_column(u'posts_postrevision', 'facebook_likes')

        # Deleting field 'PostRevision.facebook_shares'
        db.delete_column(u'posts_postrevision', 'facebook_shares')

        # Deleting field 'PostRevision.facebook_comments'
        db.delete_column(u'posts_postrevision', 'facebook_comments')
    ...
    models = {
        ...
        u'posts.author': {
            ...
            'blog_domain': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'blank': 'True'}),
        ...
        u'posts.post': {
            ...
            'twitter_favorites': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'twitter_retweets': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 21, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
