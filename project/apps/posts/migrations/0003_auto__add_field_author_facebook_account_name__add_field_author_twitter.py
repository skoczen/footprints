...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.facebook_account_name'
        db.add_column(u'posts_author', 'facebook_account_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.twitter_account_name'
        db.add_column(u'posts_author', 'twitter_account_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.facebook_account_name'
        db.delete_column(u'posts_author', 'facebook_account_name')

        # Deleting field 'Author.twitter_account_name'
        db.delete_column(u'posts_author', 'twitter_account_name')
