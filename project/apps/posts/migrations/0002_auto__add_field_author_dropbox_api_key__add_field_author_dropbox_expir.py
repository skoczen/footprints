...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Author.dropbox_expire_date'
        db.add_column(u'posts_author', 'dropbox_expire_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.facebook_api_key'
        db.add_column(u'posts_author', 'facebook_api_key',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.facebook_expire_date'
        db.add_column(u'posts_author', 'facebook_expire_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.twitter_api_key'
        db.add_column(u'posts_author', 'twitter_api_key',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.twitter_expire_date'
        db.add_column(u'posts_author', 'twitter_expire_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Author.dropbox_expire_date'
        db.delete_column(u'posts_author', 'dropbox_expire_date')

        # Deleting field 'Author.facebook_api_key'
        db.delete_column(u'posts_author', 'facebook_api_key')

        # Deleting field 'Author.facebook_expire_date'
        db.delete_column(u'posts_author', 'facebook_expire_date')

        # Deleting field 'Author.twitter_api_key'
        db.delete_column(u'posts_author', 'twitter_api_key')

        # Deleting field 'Author.twitter_expire_date'
        db.delete_column(u'posts_author', 'twitter_expire_date')
    ...
    models = {
        ...
        u'posts.author': {
            ...
            'dropbox_api_key': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
