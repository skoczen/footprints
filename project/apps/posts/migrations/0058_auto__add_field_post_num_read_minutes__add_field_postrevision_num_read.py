...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.num_read_minutes'
        db.add_column(u'posts_post', 'num_read_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=60),
                      keep_default=False)

        # Adding field 'PostRevision.num_read_minutes'
        db.add_column(u'posts_postrevision', 'num_read_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.num_read_minutes'
        db.delete_column(u'posts_post', 'num_read_minutes')

        # Deleting field 'PostRevision.num_read_minutes'
        db.delete_column(u'posts_postrevision', 'num_read_minutes')
