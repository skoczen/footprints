...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Post', fields ['dayone_id']
        db.create_unique(u'posts_post', ['dayone_id'])

        # Adding unique constraint on 'PostRevision', fields ['dayone_id']
        db.create_unique(u'posts_postrevision', ['dayone_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PostRevision', fields ['dayone_id']
        db.delete_unique(u'posts_postrevision', ['dayone_id'])

        # Removing unique constraint on 'Post', fields ['dayone_id']
        db.delete_unique(u'posts_post', ['dayone_id'])
