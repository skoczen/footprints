...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.twitter_full_name'
        db.add_column(u'posts_author', 'twitter_full_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.twitter_full_name'
        db.delete_column(u'posts_author', 'twitter_full_name')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 16, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
