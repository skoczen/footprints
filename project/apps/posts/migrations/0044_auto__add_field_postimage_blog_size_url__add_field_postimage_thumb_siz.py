...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostImage.blog_size_url'
        db.add_column(u'posts_postimage', 'blog_size_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostImage.thumb_size_url'
        db.add_column(u'posts_postimage', 'thumb_size_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostImage.blog_size_url'
        db.delete_column(u'posts_postimage', 'blog_size_url')

        # Deleting field 'PostImage.thumb_size_url'
        db.delete_column(u'posts_postimage', 'thumb_size_url')
