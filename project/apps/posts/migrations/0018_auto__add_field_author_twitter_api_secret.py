...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.twitter_api_secret'
        db.add_column(u'posts_author', 'twitter_api_secret',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.twitter_api_secret'
        db.delete_column(u'posts_author', 'twitter_api_secret')
