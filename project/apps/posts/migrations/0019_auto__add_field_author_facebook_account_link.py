...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.facebook_account_link'
        db.add_column(u'posts_author', 'facebook_account_link',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.facebook_account_link'
        db.delete_column(u'posts_author', 'facebook_account_link')
