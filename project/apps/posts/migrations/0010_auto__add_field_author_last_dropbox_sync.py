...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.last_dropbox_sync'
        db.add_column(u'posts_author', 'last_dropbox_sync',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.last_dropbox_sync'
        db.delete_column(u'posts_author', 'last_dropbox_sync')
