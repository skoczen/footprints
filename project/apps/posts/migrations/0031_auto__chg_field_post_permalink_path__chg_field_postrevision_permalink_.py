...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.permalink_path'
        db.alter_column(u'posts_post', 'permalink_path', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'PostRevision.permalink_path'
        db.alter_column(u'posts_postrevision', 'permalink_path', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Post.permalink_path'
        db.alter_column(u'posts_post', 'permalink_path', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PostRevision.permalink_path'
        db.alter_column(u'posts_postrevision', 'permalink_path', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 17, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
