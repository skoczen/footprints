...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.social_shares_customized'
        db.add_column(u'posts_post', 'social_shares_customized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Author.social_shares_customized'
        db.delete_column(u'posts_author', 'social_shares_customized')

        # Adding field 'PostRevision.social_shares_customized'
        db.add_column(u'posts_postrevision', 'social_shares_customized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.social_shares_customized'
        db.delete_column(u'posts_post', 'social_shares_customized')

        # Adding field 'Author.social_shares_customized'
        db.add_column(u'posts_author', 'social_shares_customized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PostRevision.social_shares_customized'
        db.delete_column(u'posts_postrevision', 'social_shares_customized')
