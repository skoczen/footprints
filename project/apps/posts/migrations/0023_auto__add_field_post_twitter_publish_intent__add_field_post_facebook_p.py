...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.twitter_publish_intent'
        db.add_column(u'posts_post', 'twitter_publish_intent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Post.facebook_publish_intent'
        db.add_column(u'posts_post', 'facebook_publish_intent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_publish_intent'
        db.add_column(u'posts_postrevision', 'twitter_publish_intent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PostRevision.facebook_publish_intent'
        db.add_column(u'posts_postrevision', 'facebook_publish_intent',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.twitter_publish_intent'
        db.delete_column(u'posts_post', 'twitter_publish_intent')

        # Deleting field 'Post.facebook_publish_intent'
        db.delete_column(u'posts_post', 'facebook_publish_intent')

        # Deleting field 'PostRevision.twitter_publish_intent'
        db.delete_column(u'posts_postrevision', 'twitter_publish_intent')

        # Deleting field 'PostRevision.facebook_publish_intent'
        db.delete_column(u'posts_postrevision', 'facebook_publish_intent')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 15, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
