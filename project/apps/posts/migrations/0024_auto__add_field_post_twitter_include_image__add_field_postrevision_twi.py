...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.twitter_include_image'
        db.add_column(u'posts_post', 'twitter_include_image',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_include_image'
        db.add_column(u'posts_postrevision', 'twitter_include_image',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.twitter_include_image'
        db.delete_column(u'posts_post', 'twitter_include_image')

        # Deleting field 'PostRevision.twitter_include_image'
        db.delete_column(u'posts_postrevision', 'twitter_include_image')
