...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.permalink_path'
        db.add_column(u'posts_post', 'permalink_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.permalink_path'
        db.add_column(u'posts_postrevision', 'permalink_path',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.permalink_path'
        db.delete_column(u'posts_post', 'permalink_path')

        # Deleting field 'PostRevision.permalink_path'
        db.delete_column(u'posts_postrevision', 'permalink_path')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'permalink_path': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
