...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Author.blog_domain'
        db.alter_column(u'posts_author', 'blog_domain', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Author.blog_domain'
        db.alter_column(u'posts_author', 'blog_domain', self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True))
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 22, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
