...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.dayone_image'
        db.add_column(u'posts_post', 'dayone_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.dayone_image'
        db.add_column(u'posts_postrevision', 'dayone_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.dayone_image'
        db.delete_column(u'posts_post', 'dayone_image')

        # Deleting field 'PostRevision.dayone_image'
        db.delete_column(u'posts_postrevision', 'dayone_image')
