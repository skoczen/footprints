...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.twitter_retweets'
        db.add_column(u'posts_post', 'twitter_retweets',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.twitter_favorites'
        db.add_column(u'posts_post', 'twitter_favorites',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'PostRevision.twitter_retweets'
        db.add_column(u'posts_postrevision', 'twitter_retweets',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.twitter_favorites'
        db.add_column(u'posts_postrevision', 'twitter_favorites',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Post.twitter_retweets'
        db.delete_column(u'posts_post', 'twitter_retweets')

        # Deleting field 'Post.twitter_favorites'
        db.delete_column(u'posts_post', 'twitter_favorites')
        ...
        # Deleting field 'PostRevision.twitter_retweets'
        db.delete_column(u'posts_postrevision', 'twitter_retweets')

        # Deleting field 'PostRevision.twitter_favorites'
        db.delete_column(u'posts_postrevision', 'twitter_favorites')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'twitter_likes': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'twitter_shares': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
