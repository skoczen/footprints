...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.title_html'
        db.add_column(u'posts_post', 'title_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.body_html'
        db.add_column(u'posts_post', 'body_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.title_html'
        db.add_column(u'posts_postrevision', 'title_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.body_html'
        db.add_column(u'posts_postrevision', 'body_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.title_html'
        db.delete_column(u'posts_post', 'title_html')

        # Deleting field 'Post.body_html'
        db.delete_column(u'posts_post', 'body_html')

        # Deleting field 'PostRevision.title_html'
        db.delete_column(u'posts_postrevision', 'title_html')

        # Deleting field 'PostRevision.body_html'
        db.delete_column(u'posts_postrevision', 'body_html')
