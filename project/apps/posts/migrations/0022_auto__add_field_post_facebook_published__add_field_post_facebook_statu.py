...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.facebook_published'
        db.add_column(u'posts_post', 'facebook_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Post.facebook_status_text'
        db.add_column(u'posts_post', 'facebook_status_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.facebook_status_id'
        db.add_column(u'posts_post', 'facebook_status_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.facebook_published'
        db.add_column(u'posts_postrevision', 'facebook_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PostRevision.facebook_status_text'
        db.add_column(u'posts_postrevision', 'facebook_status_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.facebook_status_id'
        db.add_column(u'posts_postrevision', 'facebook_status_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.facebook_published'
        db.delete_column(u'posts_post', 'facebook_published')

        # Deleting field 'Post.facebook_status_text'
        db.delete_column(u'posts_post', 'facebook_status_text')

        # Deleting field 'Post.facebook_status_id'
        db.delete_column(u'posts_post', 'facebook_status_id')

        # Deleting field 'PostRevision.facebook_published'
        db.delete_column(u'posts_postrevision', 'facebook_published')

        # Deleting field 'PostRevision.facebook_status_text'
        db.delete_column(u'posts_postrevision', 'facebook_status_text')

        # Deleting field 'PostRevision.facebook_status_id'
        db.delete_column(u'posts_postrevision', 'facebook_status_id')
    ...
    models = {
        ...
        u'posts.author': {
            ...
            'blog_domain': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 14, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
