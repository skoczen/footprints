...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_postimage', (
        ...
        db.send_create_signal(u'posts', ['PostImage'])


    def backwards(self, orm):
        # Deleting model 'PostImage'
        db.delete_table(u'posts_postimage')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 19, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
