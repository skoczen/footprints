...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Author', fields ['blog_domain']
        db.create_unique(u'posts_author', ['blog_domain'])


    def backwards(self, orm):
        # Removing unique constraint on 'Author', fields ['blog_domain']
        db.delete_unique(u'posts_author', ['blog_domain'])
