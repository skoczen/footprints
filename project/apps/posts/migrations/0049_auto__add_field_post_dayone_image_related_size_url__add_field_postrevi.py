...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.dayone_image_related_size_url'
        db.add_column(u'posts_post', 'dayone_image_related_size_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostRevision.dayone_image_related_size_url'
        db.add_column(u'posts_postrevision', 'dayone_image_related_size_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.dayone_image_related_size_url'
        db.delete_column(u'posts_post', 'dayone_image_related_size_url')

        # Deleting field 'PostRevision.dayone_image_related_size_url'
        db.delete_column(u'posts_postrevision', 'dayone_image_related_size_url')
    ...
    models = {
        ...
        u'posts.post': {
            ...
            'written_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 29, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'posts.postimage': {
