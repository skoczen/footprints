...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.facebook_profile_picture_url'
        db.add_column(u'posts_author', 'facebook_profile_picture_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.twitter_profile_picture_url'
        db.add_column(u'posts_author', 'twitter_profile_picture_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.facebook_profile_picture_url'
        db.delete_column(u'posts_author', 'facebook_profile_picture_url')

        # Deleting field 'Author.twitter_profile_picture_url'
        db.delete_column(u'posts_author', 'twitter_profile_picture_url')
