...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Redirect.new_url'
        db.alter_column(u'posts_redirect', 'new_url', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))

        # Changing field 'Redirect.old_url'
        db.alter_column(u'posts_redirect', 'old_url', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Redirect.new_url'
        raise RuntimeError("Cannot reverse this migration. 'Redirect.new_url' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Redirect.new_url'
        db.alter_column(u'posts_redirect', 'new_url', self.gf('django.db.models.fields.CharField')(max_length=600))

        # User chose to not deal with backwards NULL issues for 'Redirect.old_url'
        raise RuntimeError("Cannot reverse this migration. 'Redirect.old_url' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Redirect.old_url'
        db.alter_column(u'posts_redirect', 'old_url', self.gf('django.db.models.fields.CharField')(max_length=600))
